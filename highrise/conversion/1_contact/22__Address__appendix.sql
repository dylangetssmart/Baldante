/*---
description: Ensures each individual/organization contact has an [sma_MST_Address] record

steps: >
  - Disable triggers on [sma_MST_Address]
  - Insert Other addresses for Individual Contacts who have no addresses
  - Insert Other addresses for Organization Contacts who have no addresses
  - Update primary addresses for Individual Contacts
  - Update primary addresses for Organization Contacts
  - Enable triggers on [sma_MST_Address]

dependencies:
  - \1_contact\20__Address__IndvContacts.sql
  - \1_contact\21__Address__OrgContacts.sql
