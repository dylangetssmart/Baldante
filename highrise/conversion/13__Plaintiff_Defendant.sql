...
insert into [sma_TRN_Plaintiff]
	...
	select
		...
		ioci.CTG		as [plnncontactctg],
		ioci.CID		as [plnncontactid],
		ioci.AID		as [plnnaddressid],
	...
	join [sma_MST_SubRole] s
		on cas.casnOrgCaseTypeID = s.sbrnCaseTypeID
			and s.sbrsDscrptn = '(P)-Default Role'
			and s.sbrnRoleID = 4
...
-- every case need at least one plaintiff
insert into [sma_TRN_Plaintiff]
	(
		[plnnCaseID],
		[plnnContactCtg],
