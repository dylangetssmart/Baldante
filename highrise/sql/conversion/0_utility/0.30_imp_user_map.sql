/*
This script manages the population of the `implementation_users` table for the BaldanteHighriseSA project.
...
--		FROM [BaldanteHighriseSA]..sma_mst_users u
--		JOIN [BaldanteHighriseSA]..sma_MST_IndvContacts smic
