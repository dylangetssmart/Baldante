...
def insert_entities(file_path, engine, entities, table_name, entity_label, parent_id, logger, progress=None):
    """
    ...
    for entity in entities:
        try:
            insert_to_sql_server(file_path, engine, table_name, entity, logger)
